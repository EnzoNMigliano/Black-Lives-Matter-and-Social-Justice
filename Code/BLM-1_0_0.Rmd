...
The data utilized in the analysis was collected from different reliable sources (e.g., government, news papers, Kaggle). The was collected in the month of September and October of 2020, and it was uploaded into an online repository in the web server "GitHub".
...
In order to perform the analysis of the data we utilized the software R(Version 4.0.2) [1], emulated in the Rstudio(Version 1.3.1073) [2]. In order to perform the version control of the documents throughout the study was utilized in the Software Git [3] in connection with the server of GitHub [4].

### Packages

In order to perform the analysis of the data we utilized the packages: Tidyverse [5], Corrplot [6], CaTools [7], caret [8], and forecast [9].
