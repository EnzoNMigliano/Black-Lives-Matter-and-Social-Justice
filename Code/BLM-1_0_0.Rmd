...
NY_StopFrisk_2016Tidy <- NY_StopFrisk_2016 %>% subset(select = c(year, datestop, timestop, crimsusp, explnstp, 
                                                                  offunif, frisked, searched, contrabn,                                                              
                                                                  pf_hcuff, forceuse, sex, race, age, ht_feet,
                                                                  weight, build, city, pistol, riflshot, asltweap, knifcuti))
