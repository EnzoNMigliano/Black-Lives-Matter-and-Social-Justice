...
COnstructing a model to predict the shootings involving CAucasians:

```{r}
WModelShootings <- auto.arima(TSWhite)
```


```{r}
WShootingsForecast <- forecast(WModelShootings, h = 12)
WShootingsForecast
```
