...
This data set maintained by the 
...
This data set maintaned by the Federal Bureau of Investigation has informaiton by the civilians employed in the law enforcement agencies, as the number of active officer in different regions of the United States.
