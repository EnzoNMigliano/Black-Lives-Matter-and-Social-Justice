...
The Chicago Crimes 2011 to present is not Tidy yet. The variable data has two values the date and time. Therefore, we need to separate the values into two cells. One cell will be for the vairable date and the other will be for the variable time. 
