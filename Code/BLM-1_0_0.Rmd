...
In order to perform the analysis of the data we utilized the software R(Version 4.0.2), emulated in the Rstudio(Version 1.3.1073). In order to perform the version control of the documetns throughout the study was utilized in the Software Git in connection with the server of GitHub.

### Instaling Necessary Packages

In order to perform the analysis of the data we utilized several packages 
